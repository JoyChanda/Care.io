...
import { CreditCard, Calendar, User, Package, ChevronLeft, Search, Filter } from "lucide-react";
    ...
    <main className="max-w-7xl mx-auto px-6 py-16 min-h-screen">
      ...
      >
        ...
        <div className="px-8 py-6 bg-base-200/30 flex items-center justify-between">
          <p className="text-xs font-bold text-base-content/40 uppercase tracking-widest">Showing 4 of 48 transactions</p>
          <div className="flex gap-2">
            <button className="btn btn-sm btn-outline border-base-200 rounded-lg opacity-50 cursor-not-allowed">Prev</button>
            <button className="btn btn-sm btn-primary rounded-lg">Next</button>
          </div>
        </div>
      </motion.div>
    </main>
