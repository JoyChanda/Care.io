            ...
            {success ? (
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="btn btn-block h-14 bg-white hover:bg-gray-50 text-gray-900 border border-gray-200 rounded-2xl gap-3 shadow-sm hover:shadow-md transition-all normal-case font-bold text-base"
                >
